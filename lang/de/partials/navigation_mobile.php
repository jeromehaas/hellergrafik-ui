<nav class="navigation-mobile">
    ...
    <div class="navigation-mobile__link-background">
        <ul class="navigation-mobile__link-background__list">
            ...
            <li class="navigation-mobile__link-background__list-item"><a class="navigation-mobile__link-background__list-item__link default-link" href="http://localhost:8888/grafik_heller/lang/de/pages/contact.php">Kontakt</a></li>
        </ul>
    </div>
</nav>
