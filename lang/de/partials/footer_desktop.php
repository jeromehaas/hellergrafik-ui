<footer class="footer-desktop">
    ...
    <address class="footer-desktop__column footer-desktop__column--one">
        <a class="footer-desktop__logo__link" href="/index.php">
            <img class="footer-desktop__logo" src="/media/logo/logo.svg" alt="heller grafik">
        </a>
    </address>
    ...
    <address class="footer-desktop__column footer-desktop__column--three">
        <a class="footer-desktop__column-three__item default-link" href="/lang/de/pages/impressum.php">Impressum</a>
        <a class="footer-desktop__column-three__item default-link" href="/lang/de/pages/privacy.php">Datenschutz</a>
