$(document).ready(function() {
    ...
    let animationo = (function() {
        ...
        $(document).ready(function() {
            ...
            let createBubbles = function() {
                ...
                let marginBetweenBubbles = Math.round(screenWidth / 20);
    ...
    /*
        if ($.cookie('seen') != 'yes') {
            ...
            $('.preloader-img').addClass('show');


            setTimeout(function () {
                $('.preloader').css('transitionDuration', '2s');
                $('.preloader-img').css('transitionDuration', '2s');
                $('.preloader-img').removeClass('show');
            }, 2000);
            ...
            $.cookie('seen', 'yes', { expires: 1, path: '/' });

            console.log("hello")

        } else {

            console.log("cookie is already setted...");
